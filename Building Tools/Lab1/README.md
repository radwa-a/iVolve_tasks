...
$ ls
```
<img width="1071" height="316" alt="clone repo" src="https://github.com/user-attachments/assets/fa078332-dc20-4054-8870-99743a531a6a" />
...
$ gradle test
```
<img width="1167" height="232" alt="test" src="https://github.com/user-attachments/assets/304ded44-a69b-41ba-bf8c-9c94effc7e8b" />
...
$ gradle build
```
<img width="1162" height="231" alt="image" src="https://github.com/user-attachments/assets/c29a5174-0704-4590-a7dd-9b117b5136e3" />

## step 4: Run the Appliction.
```bash
$ java -jar build/libs/ivolve-app.jar
```
<img width="1086" height="142" alt="image" src="https://github.com/user-attachments/assets/8ca10a0b-97b7-4616-a31e-2be7ef40bdc8" />
